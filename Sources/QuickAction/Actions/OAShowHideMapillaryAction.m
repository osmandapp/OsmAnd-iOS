...
{
    if (!TYPE)
        TYPE = [[OAQuickActionType alloc] initWithIdentifier:33 stringId:@"mapillary.showhid" class:self.class name:OALocalizedString(@"quick_action_showhide_mapillary_title") category:CONFIGURE_MAP iconName:@"ic_custom_mapillary_symbol" secondaryIconName:nil editable:NO];
