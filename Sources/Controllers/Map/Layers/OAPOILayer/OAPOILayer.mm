...
- (void)onMapFrameRendered
{
    ...
    float currentZoom = [self.mapView zoom];
...
//- (void)updateTopPlacesCollection
//{
//    //NSLog(@"[test] updateTopPlacesCollection 0");
//    NSArray<OAPOI *> *places = _topPlaces ? [_topPlaces allValues] : nil;
//    if (!places)
//    {
//        [self clearMapMarkersCollections];
...
//   // NSLog(@"[test] updateTopPlacesCollection 1");
//    for (OAPOI *place in places)
//    {
//       // NSInteger placeId = place.obfId ?: place.getTravelEloNumber;
//        long long fullId = place.obfId ?: place.getTravelEloNumber;
//        int32_t placeId = (int32_t)(fullId ^ (fullId >> 32));
//        
...
//    }
//    NSLog(@"[test] updateTopPlacesCollection 2, %lu count", static_cast<unsigned long>(mapPlaces.count));
//    for (OAMapTopPlace *place in mapPlaces)
//    {
//        if (place.alreadyExists) {
//            NSLog(@"[test] updateTopPlacesCollection place.alreadyExist ");
//            continue;
//        }
//        NSData *data = UIImagePNGRepresentation(place.image);
//        if (data) {
...
//                .buildAndAddToCollection(_mapMarkersCollection);
//        } else {
//            NSLog(@"[test] UIImageJPEGRepresentation is nil");
//        }
//        NSLog(@"[test] updateTopPlacesCollection 3");
//    }
//    // TOP_PLACES_POI_SECTION
//    NSLog(@"[test] addSymbolsProvider");
//    self.mapView.renderer->addSymbolsProvider(kFavoritesSymbolSection, _mapMarkersCollection);
//}
