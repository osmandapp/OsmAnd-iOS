...
@interface OAWaypointsMainScreen () <OAAppModeCellDelegate>
...
- (id) initWithTable:(UITableView *)tableView viewController:(OAWaypointsViewController *)viewController
{
    self = [super init];
    if (self)
    {
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [tableView deselectRowAtIndexPath:indexPath animated:waypointsViewController == nil];
}
