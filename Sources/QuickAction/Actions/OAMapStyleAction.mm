...
- (void)execute
{
    ...
    if (mapStyles.count > 0)
    {
        ...
        {
            OAQuickActionSelectionBottomSheetViewController *bottomSheet = [[OAQuickActionSelectionBottomSheetViewController alloc] initWithAction:self type:EOAQASelectionTypeStyle];
            [bottomSheet show];
            return;
        }
