...
final class StartNewTripSegmentAction: BaseMonitoringAction {
    private static let type = QuickActionType(id: QuickActionIds.startNewTripSegmentAction.rawValue, stringId: "start.new.trip.segment", cl: StartNewTripSegmentAction.self)
