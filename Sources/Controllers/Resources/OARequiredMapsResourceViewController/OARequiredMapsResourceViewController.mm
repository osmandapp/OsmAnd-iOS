...
@implementation OARequiredMapsResourceViewController
{
    ...
    NSArray<OAResourceItem *> * _selectedResourcesItems;
...
{
    NSArray<OAWorldRegion *> *regions = [_missingMaps arrayByAddingObjectsFromArray:_mapsToUpdate];
