...
static const CGFloat MDCTextFieldClearButtonImageBuiltInPadding = (CGFloat)-2.5;

static inline CGRect MDCTextFieldRectFlippedHorizontally(CGRect rect, CGFloat containerWidth) {
  rect.origin.x = containerWidth - CGRectGetMaxX(rect);
  return rect;
}
...
- (CGRect)textRectForBounds:(CGRect)bounds {
  ...
  if (self.rightView.superview) {
    ...
    clearButtonWidth += 2 * MDCTextFieldClearButtonImageBuiltInPadding;
  ...
  if (self.effectiveUserInterfaceLayoutDirection == UIUserInterfaceLayoutDirectionRightToLeft) {
    ...
    textRect = MDCTextFieldRectFlippedHorizontally(textRect, CGRectGetWidth(bounds));
  }
...
- (CGRect)editingRectForBounds:(CGRect)bounds {
  ...
  if (self.effectiveUserInterfaceLayoutDirection == UIUserInterfaceLayoutDirectionRightToLeft) {
    editingRect = MDCTextFieldRectFlippedHorizontally(editingRect, CGRectGetWidth(bounds));
  }
