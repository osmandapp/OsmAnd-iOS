...
+ (nullable UIImage *) imageNamed:(nullable NSString *)name renderingMode:(UIImageRenderingMode)mode shouldSearchInMapSVGResource:(BOOL)shouldSearchInMapSVGResource;
