...
final class TracksFiltersViewController: OABaseButtonsViewController {
    ...
    override func getBottomButtonTitle() -> String? {
        String(format: localizedString("ltr_or_rtl_combine_with_brackets"), localizedString("shared_string_show"), NumberFormatter.localizedCount(baseFilters.getFilteredTrackItems().count))
    }
    ...
    override func generateData() {
        ...
        nameRow.title = (baseFilters.getFilterByType(.name) as? TextTrackFilter)?.value
        ...
        visibleOnMapRow.setObj((baseFilters.getFilterByType(.other) as? OtherTrackFilter)?.isParamSelected(param: .visibleOnMap) ?? false, forKey: Self.selectedKey)
