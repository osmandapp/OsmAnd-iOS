...
@implementation OATestOkioSource
...
@implementation OATestOBDConnector
{
...
//    auto pair = [[OASKotlinPair alloc] initWithFirst:itemSource second:itemSink];
    ...
    auto pair = [[OASKotlinPair alloc] initWithFirst:_simulator.reader second:_simulator.writer];
...
//@protocol OASOBDConnector
//@required
//- (OASKotlinPair<id<OASOkioSource>, id<OASOkioSink>> * _Nullable)connect __attribute__((swift_name("connect()")));
//- (void)disconnect __attribute__((swift_name("disconnect()")));
//- (void)onConnectionFailed __attribute__((swift_name("onConnectionFailed()")));
//- (void)onConnectionSuccess __attribute__((swift_name("onConnectionSuccess()")));
//@end
