...
- (void)viewDidLoad
{
    ...
    _optionButtonWidthConstraint.constant = [OAUtilities calculateTextBounds:OALocalizedString(@"shared_string_options") width:DeviceScreenWidth height:44 font:[UIFont preferredFontForTextStyle:UIFontTextStyleBody]].width + 16;
    _addButtonWidthConstraint.constant = [OAUtilities calculateTextBounds:OALocalizedString(@"coord_input_add_point") width:DeviceScreenWidth height:44 font:[UIFont preferredFontForTextStyle:UIFontTextStyleBody]].width + 16;
...
//                snackbar.show();
    ...
    if (gpxFilePath && [_settings isGpxVisible:gpxFilePath])
    {
