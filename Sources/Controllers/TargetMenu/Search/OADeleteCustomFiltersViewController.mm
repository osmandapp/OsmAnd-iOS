...
{
    NSString *cellType = indexPath.row == 0 ? [OAButtonTableViewCell getCellIdentifier] : [OAMenuSimpleCell getCellIdentifier];
    if ([cellType isEqualToString:[OAButtonTableViewCell getCellIdentifier]])
    {
