...
static const float kTargetMoveVelocityLimit = 4000.0f;
static const float kTargetMoveDeceleration = 6000.0f;
...
@property(nonatomic) double viewportXScale;
...
- (void)fetchAltitudesForCoordinates:(NSArray<NSValue *> *)coordinates callback:(void (^)(NSArray<NSNumber *> *heights))callback;
