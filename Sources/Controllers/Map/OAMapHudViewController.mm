...
- (void) updateControlsLayout:(BOOL)animated
{
    ...
    if (isToolbarVisible)
    {
        BOOL isAllowToolbarsVisible = (isToolbarVisible && [_mapPanelViewController isTopToolbarSearchVisible]) || (isToolbarVisible && [_mapPanelViewController isTopToolbarDiscountVisible]);
