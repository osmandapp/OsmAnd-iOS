...
{
    if (!PROFILE)
        PROFILE = [[OAExportSettingsType alloc] initWithTitle:OALocalizedString(@"shared_string_profiles") name:@"PROFILE" itemName:@"PROFILE" icon:[UIImage templateImageNamed:@"ic_custom_manage_profiles"] isAvailableInFreeVersion:YES];
    return PROFILE;
}
...
{
    if (!GLOBAL)
        GLOBAL = [[OAExportSettingsType alloc] initWithTitle:OALocalizedString(@"general_settings_2") name:@"GLOBAL" itemName:@"GLOBAL" icon:[UIImage templateImageNamed:@"left_menu_icon_settings"] isAvailableInFreeVersion:YES];
    return GLOBAL;
}
...
{
    if (!QUICK_ACTIONS)
        QUICK_ACTIONS = [[OAExportSettingsType alloc] initWithTitle:OALocalizedString(@"shared_string_quick_actions") name:@"QUICK_ACTIONS" itemName:@"QUICK_ACTIONS" icon:[UIImage templateImageNamed:@"ic_custom_quick_action"] isAvailableInFreeVersion:NO];
...
{
    if (!POI_TYPES)
        POI_TYPES = [[OAExportSettingsType alloc] initWithTitle:OALocalizedString(@"shared_string_poi_types") name:@"POI_TYPES" itemName:@"POI_UI_FILTERS" icon:[UIImage templateImageNamed:@"ic_custom_search_categories"] isAvailableInFreeVersion:NO];
    return POI_TYPES;
}
...
{
    if (!AVOID_ROADS)
        AVOID_ROADS = [[OAExportSettingsType alloc] initWithTitle:OALocalizedString(@"avoid_road") name:@"AVOID_ROADS" itemName:@"AVOID_ROADS" icon:[UIImage templateImageNamed:@"ic_custom_alert"] isAvailableInFreeVersion:NO];
    return AVOID_ROADS;
}
...
{
    if (!FAVORITES)
        FAVORITES = [[OAExportSettingsType alloc] initWithTitle:OALocalizedString(@"favorites_item") name:@"FAVORITES" itemName:@"FAVOURITES" icon:[UIImage templateImageNamed:@"ic_custom_my_places"] isAvailableInFreeVersion:YES];
    return FAVORITES;
}
...
{
    if (!TRACKS)
        TRACKS = [[OAExportSettingsType alloc] initWithTitle:OALocalizedString(@"shared_string_gpx_tracks") name:@"TRACKS" itemName:@"GPX" icon:[UIImage templateImageNamed:@"ic_custom_trip"] isAvailableInFreeVersion:NO];
    return TRACKS;
}
...
{
    if (!OSM_NOTES)
        OSM_NOTES = [[OAExportSettingsType alloc] initWithTitle:OALocalizedString(@"osm_notes") name:@"OSM_NOTES" itemName:@"OSM_NOTES" icon:[UIImage templateImageNamed:@"ic_action_osm_note"] isAvailableInFreeVersion:YES];
    return OSM_NOTES;
}
...
{
    if (!OSM_EDITS)
        OSM_EDITS = [[OAExportSettingsType alloc] initWithTitle:OALocalizedString(@"osm_edits_title") name:@"OSM_EDITS" itemName:@"OSM_EDITS" icon:[UIImage templateImageNamed:@"ic_custom_osm_edits"] isAvailableInFreeVersion:YES];
    return OSM_EDITS;
}
...
{
    if (!ACTIVE_MARKERS)
        ACTIVE_MARKERS = [[OAExportSettingsType alloc] initWithTitle:OALocalizedString(@"map_markers") name:@"ACTIVE_MARKERS" itemName:@"ACTIVE_MARKERS" icon:[UIImage templateImageNamed:@"ic_custom_marker"] isAvailableInFreeVersion:NO];
...
{
    if (!HISTORY_MARKERS)
        HISTORY_MARKERS = [[OAExportSettingsType alloc] initWithTitle:OALocalizedString(@"markers_history") name:@"HISTORY_MARKERS" itemName:@"HISTORY_MARKERS" icon:[UIImage templateImageNamed:@"ic_custom_marker"] isAvailableInFreeVersion:NO];
...
{
    if (!SEARCH_HISTORY)
        SEARCH_HISTORY = [[OAExportSettingsType alloc] initWithTitle:OALocalizedString(@"shared_string_search_history") name:@"SEARCH_HISTORY" itemName:@"SEARCH_HISTORY" icon:[UIImage templateImageNamed:@"ic_custom_search"] isAvailableInFreeVersion:NO];
...
+ (OAExportSettingsType *)NAVIGATION_HISTORY
{
    if (!NAVIGATION_HISTORY)
        NAVIGATION_HISTORY = [[OAExportSettingsType alloc] initWithTitle:OALocalizedString(@"navigation_history") name:@"NAVIGATION_HISTORY" itemName:@"NAVIGATION_HISTORY" icon:[UIImage templateImageNamed:@"ic_custom_navigation"] isAvailableInFreeVersion:NO];
...
+ (OAExportSettingsType *)CUSTOM_RENDER_STYLE
{
    if (!CUSTOM_RENDER_STYLE)
        CUSTOM_RENDER_STYLE = [[OAExportSettingsType alloc] initWithTitle:OALocalizedString(@"shared_string_rendering_style") name:@"CUSTOM_RENDER_STYLE" itemName:@"FILE" icon:[UIImage templateImageNamed:@"ic_custom_map_style"] isAvailableInFreeVersion:NO];
    return CUSTOM_RENDER_STYLE;
}
...
{
    if (!CUSTOM_ROUTING)
        CUSTOM_ROUTING = [[OAExportSettingsType alloc] initWithTitle:OALocalizedString(@"shared_string_routing") name:@"CUSTOM_ROUTING" itemName:@"FILE" icon:[UIImage templateImageNamed:@"ic_custom_file_routing"] isAvailableInFreeVersion:NO];
    return CUSTOM_ROUTING;
}
...
{
    if (!MAP_SOURCES)
        MAP_SOURCES = [[OAExportSettingsType alloc] initWithTitle:OALocalizedString(@"quick_action_map_source_title") name:@"MAP_SOURCES" itemName:@"MAP_SOURCES" icon:[UIImage templateImageNamed:@"ic_custom_globe_latitude"] isAvailableInFreeVersion:NO];
    return MAP_SOURCES;
}
...
{
    if (!OFFLINE_MAPS)
        OFFLINE_MAPS = [[OAExportSettingsType alloc] initWithTitle:OALocalizedString(@"offline_maps") name:@"OFFLINE_MAPS" itemName:@"FILE" icon:[UIImage templateImageNamed:@"ic_custom_map"] isAvailableInFreeVersion:NO];
    return OFFLINE_MAPS;
}
...
{
    if (!COLOR_DATA)
        COLOR_DATA = [[OAExportSettingsType alloc] initWithTitle:OALocalizedString(@"shared_string_colors") name:@"COLOR_DATA" itemName:@"FILE" icon:[UIImage templateImageNamed:@"ic_custom_appearance"] isAvailableInFreeVersion:NO];
    return COLOR_DATA;
}
