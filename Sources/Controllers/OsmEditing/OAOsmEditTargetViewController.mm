...
- (void) buildRows:(NSMutableArray<OARowInfo *> *)rows
{
        ...
        && ![type isKindOfClass:[OAPOIMyLocationType class]])
    {
        ...
        [rows addObject:[[OARowInfo alloc] initWithKey:type.name icon:icon iconName:[type iconName] textPrefix:nil text:[_osmPoint getSubType] textColor:nil isText:NO needLinks:NO order:0 typeName:@"" isPhoneNumber:NO isUrl:NO]];
    }
    ...
    [_osmPoint.getTags enumerateKeysAndObjectsUsingBlock:^(NSString *key, NSString *value, BOOL * _Nonnull stop) {
        ...
        if (!skip)
        {
            [descriptions addObject:[[OARowInfo alloc] initWithKey:@"" icon:[OATargetInfoViewController getIcon:@"ic_description.png"] iconName:@"ic_description.png" textPrefix:textPrefix text:[NSString stringWithFormat:@"%@=%@", key, value] textColor:nil isText:YES needLinks:YES order:0 typeName:@"" isPhoneNumber:NO isUrl:NO]];
