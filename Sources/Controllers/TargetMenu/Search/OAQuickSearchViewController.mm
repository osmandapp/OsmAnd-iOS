...
- (void)searchToolbarOpenSearch:(OAPOIUIFilter *)filter
{
    ...
    {
        [[OARootViewController instance].mapPanel hideToolbar:_searchToolbarViewController];
        [[OARootViewController instance].mapPanel saveSearchQuery:filter location:[[CLLocation alloc] initWithLatitude:_searchLocation.latitude longitude:_searchLocation.longitude] searchQuery:_searchQuery ?: @""];
    }
    else
    {
