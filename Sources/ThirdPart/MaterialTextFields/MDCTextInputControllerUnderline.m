...
static CGFloat _underlineControllerHeightActiveDefault =
    MDCTextInputControllerUnderlineDefaultUnderlineActiveHeight;
static CGFloat _underlineControllerHeightNormalDefault =
...
+ (CGFloat)underlineHeightActiveDefault {
  return _underlineControllerHeightActiveDefault;
}

+ (void)setUnderlineHeightActiveDefault:(CGFloat)underlineHeightActiveDefault {
  _underlineControllerHeightActiveDefault = underlineHeightActiveDefault;
}

+ (CGFloat)underlineHeightNormalDefault {
  return _underlineControllerHeightNormalDefault;
}

+ (void)setUnderlineHeightNormalDefault:(CGFloat)underlineHeightNormalDefault {
  _underlineControllerHeightNormalDefault = underlineHeightNormalDefault;
}
