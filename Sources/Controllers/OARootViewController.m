...
- (void) zoomOut
{
    if ([[OAAppSettings sharedManager].settingExternalInputDevice get:[OAAppSettings sharedManager].applicationMode] != NO_EXTERNAL_DEVICE)
    {
...
- (void) goBack
{
    if ([[OAAppSettings sharedManager].settingExternalInputDevice get:[OAAppSettings sharedManager].applicationMode] == WUNDERLINQ_EXTERNAL_DEVICE)
    {
        //Launch WunderLINQ
