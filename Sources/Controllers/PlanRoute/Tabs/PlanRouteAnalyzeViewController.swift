...
extension PlanRouteAnalyzeViewController: UITableViewDataSource {
    ...
    private func makeChartSectionCell(_ tableView: UITableView, _ indexPath: IndexPath) -> UITableViewCell {
        ...
        recalcSeparator.backgroundColor = .adaptiveSeparator
        ...
        NSLayoutConstraint.activate([
            ...
            recalcSeparator.heightAnchor.constraint(equalToConstant: UIScreen.adaptiveSeparatorThickness),
    ...
    private func makeStatsSectionCell(_ tableView: UITableView, _ indexPath: IndexPath) -> UITableViewCell {
        ...
        let hDivider = UIView()
        hDivider.backgroundColor = .adaptiveSeparator
        ...
        NSLayoutConstraint.activate([
            ...
            hDivider.heightAnchor.constraint(equalToConstant: UIScreen.adaptiveSeparatorThickness),
    ...
    private func makeVerticalDivider() -> UIView {
        ...
        wrapper.widthAnchor.constraint(equalToConstant: UIScreen.adaptiveSeparatorThickness).isActive = true

        let line = UIView()
        line.backgroundColor = .adaptiveSeparator
    ...
    private func makeExpandedRoadAttrLegend(stat: OARouteStatistics) -> UIView {
        ...
        for (index, item) in items.enumerated() {
            ...
            separatorContainer.heightAnchor.constraint(equalToConstant: UIScreen.adaptiveSeparatorThickness).isActive = true

            let separator = UIView()
            separator.backgroundColor = .adaptiveSeparator
