...
- (void)commonInit
{
    ...
    self.editName = @"";
    self.editIconName = @"";
    self.editColor = UIColorFromARGB([_appearanceCollection getDefaultPointColorItem].colorInt);
...
- (UITableViewCell *)getRow:(NSIndexPath *)indexPath
{
    ...
    else if ([item.cellType isEqualToString:[OAColorsPaletteCell getCellIdentifier]])
    {
        ...
        if (cell)
        {
            ...
            cell.hostVC = self;
            [_colorCollectionHandler setSelectionItem:_selectedColorItem ?: [_appearanceCollection getDefaultPointColorItem]];
