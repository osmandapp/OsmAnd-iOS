...
- (void) setupPoints
{
    ...
    if (pointToStart)
    {
        ...
        .setIsHidden(false)
        .setPinIcon(OsmAnd::SingleSkImage([OANativeUtilities skImageFromAssetNamed:ACImageNameMapStartPoint]))
    ...
    if (pointToNavigate)
    {
        ...
        .setIsHidden(false)
        .setPinIcon(OsmAnd::SingleSkImage([OANativeUtilities skImageFromAssetNamed:ACImageNameMapTargetPoint]))
        .setPinIconVerticalAlignment(OsmAnd::MapMarker::Top)
        .setPinIconHorisontalAlignment(OsmAnd::MapMarker::CenterHorizontal)
        .setPosition(OsmAnd::Utilities::convertLatLonTo31(latLon))
        .buildAndAddToCollection(_markersCollection);
