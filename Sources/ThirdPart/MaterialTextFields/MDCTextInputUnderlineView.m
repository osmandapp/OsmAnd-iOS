...
static inline UIColor *MDCTextInputUnderlineViewDefaultColor() {
...
- (void)commonMDCUnderlineViewInit {
  _color = MDCTextInputUnderlineViewDefaultColor();
  _disabledColor = MDCTextInputUnderlineViewDefaultColor();
  _enabled = YES;
