...
class WidgetType: NSObject {
    ...
    let disconnectedIconName: String?
    let docsUrl: String?
    ...
    private init(ordinal: Int, id: String, title: String, descr: String, iconName: String, disabledIconName: String? = nil, disconnectedIconName: String? = nil, docsUrl: String? = nil, group: WidgetGroup? = nil, verticalGroup: WidgetGroup? = nil, defaultPanel: WidgetsPanel, special: Bool = false) {
        ...
        self.disconnectedIconName = disconnectedIconName
...
extension WidgetType {
    ...
    // External sensors
    static let heartRate = WidgetType(ordinal: 48, id: "ant_heart_rate", title: localizedString("map_widget_ant_heart_rate"), descr: localizedString("map_widget_ant_heart_rate_desc"), iconName: "widget_sensor_heart_rate", disabledIconName: "ic_custom_sensor_heart_rate_outlined", disconnectedIconName: "widget_sensor_heart_rate_disconnected", group: .externalSensors, defaultPanel: .rightPanel)
    
    static let bicycleCadence = WidgetType(ordinal: 49, id: "ant_bicycle_cadence", title: localizedString("map_widget_ant_bicycle_cadence"), descr: localizedString("map_widget_ant_bicycle_cadence_desc"), iconName: "widget_sensor_cadence", disabledIconName: "ic_custom_sensor_cadence_outlined", disconnectedIconName: "widget_sensor_cadence_disconnected", group: .externalSensors, defaultPanel: .rightPanel)
    
    static let bicycleDistance = WidgetType(ordinal: 50, id: "ant_bicycle_distance", title: localizedString("map_widget_ant_bicycle_dist"), descr: localizedString("map_widget_ant_bicycle_dist_desc"), iconName: "widget_sensor_distance", disabledIconName: "ic_custom_sensor_distance_outlined", disconnectedIconName: "widget_sensor_distance_disconnected", group: .externalSensors, defaultPanel: .rightPanel)
    
    static let bicycleSpeed = WidgetType(ordinal: 51, id: "ant_bicycle_speed", title: localizedString("map_widget_ant_bicycle_speed"), descr: localizedString("map_widget_ant_bicycle_speed_desc"), iconName: "widget_sensor_speed", disabledIconName: "ic_custom_sensor_speed_outlined", disconnectedIconName: "widget_sensor_speed_disconnected", group: .externalSensors, defaultPanel: .rightPanel)
    
    static let temperature = WidgetType(ordinal: 52, id: "temperature_sensor", title: localizedString("shared_string_temperature"), descr: localizedString("sensor_temperature_desc"), iconName: "widget_sensor_temperature", disabledIconName: "ic_custom_sensor_thermometer", disconnectedIconName: "widget_sensor_temperature_disconnected", group: .externalSensors, defaultPanel: .rightPanel)
