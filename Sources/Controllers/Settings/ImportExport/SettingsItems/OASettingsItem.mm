...
{
    return self.fileName ? ([self.fileName hasSuffix:fileName] || [fileName hasPrefix:[self.fileName stringByAppendingString:@"/"]] || [fileName compare:self.fileName] == NSOrderedSame) : NO;
}
