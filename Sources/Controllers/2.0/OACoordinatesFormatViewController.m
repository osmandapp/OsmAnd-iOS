...
- (void) setupView
{
    ...
    _data = @[
        ...
        @"selected" : @(_settings.settingGeoFormat == MAP_GEO_FORMAT_DEGREES),
    ...
    @{
        ...
        @"selected" : @(_settings.settingGeoFormat == MAP_GEO_FORMAT_MINUTES),
    ...
    @{
       ...
       @"selected" : @(_settings.settingGeoFormat == MAP_GEO_FORMAT_SECONDS),
    ...
    @{
        ...
        @"selected" : @(_settings.settingGeoFormat == MAP_GEO_UTM_FORMAT),
    ...
    @{
       ...
       @"selected" : @(_settings.settingGeoFormat == MAP_GEO_OLC_FORMAT),
...
- (void) selectSettingGeoCode:(NSString *)name
{
    if ([name isEqualToString:@"navigate_point_format_D"])
        [_settings setSettingGeoFormat:MAP_GEO_FORMAT_DEGREES];
    else if ([name isEqualToString:@"navigate_point_format_DM"])
        [_settings setSettingGeoFormat:MAP_GEO_FORMAT_MINUTES];
    else if ([name isEqualToString:@"navigate_point_format_DMS"])
        [_settings setSettingGeoFormat:MAP_GEO_FORMAT_SECONDS];
    else if ([name isEqualToString:@"utm_format"])
        [_settings setSettingGeoFormat:MAP_GEO_UTM_FORMAT];
    else if ([name isEqualToString:@"olc_format"])
        [_settings setSettingGeoFormat:MAP_GEO_OLC_FORMAT];
}
