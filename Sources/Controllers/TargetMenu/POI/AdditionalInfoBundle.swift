...
final class AdditionalInfoBundle: NSObject {
    ...
    private static let HIDDEN_EXTENSIONS: [String] = [COLOR_NAME_EXTENSION_KEY, ICON_NAME_EXTENSION_KEY, BACKGROUND_TYPE_EXTENSION_KEY, PROFILE_TYPE_EXTENSION_KEY, ADDRESS_EXTENSION_KEY, AMENITY_ORIGIN_EXTENSION_KEY, POITYPE, SUBTYPE, GpxUtilities.shared.OSM_URL_EXTENSION]
