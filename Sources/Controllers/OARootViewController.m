...
{
    [self importAsGPX:url showAlerts:showAlerts openGpxView:openGpxView reload:NO onComplete:nil];
}
         ...
         onComplete:(void (^)(void))onComplete
{
    ...
    if (gpxController == nil)
        return;
    [gpxController prepareProcessUrl:url showAlerts:showAlerts openGpxView:openGpxView reload:reload onComplete:onComplete];
