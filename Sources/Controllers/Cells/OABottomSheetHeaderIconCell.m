...
- (void) layoutSubviews
{
    ...
    _iconView.frame = CGRectMake(DeviceScreenWidth - _iconView.frame.size.width - horizontalMargin, cellSize.height / 2 - _iconView.frame.size.height / 2, iconSize, iconSize);
