...
- (instancetype) init
{
    ...
    if (self)
    {
        ...
        _coordinateGridMinZoom = [[OACommonInteger withKey:coordinateGridMinZoomKey defValue:2] makeProfile];
        _coordinateGridMaxZoom = [[OACommonInteger withKey:coordinateGridMaxZoomKey defValue:22] makeProfile];
