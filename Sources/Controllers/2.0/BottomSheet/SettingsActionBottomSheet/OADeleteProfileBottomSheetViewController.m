...
- (UIView *) tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    description.attributedText = [OAUtilities getStringWithBoldPart:descriptionString mainString:[NSString stringWithFormat:OALocalizedString(@"profile_alert_delete_msg"), _appMode.toHumanString] boldString:_appMode.toHumanString lineSpacing:4. highlightColor:nil];
